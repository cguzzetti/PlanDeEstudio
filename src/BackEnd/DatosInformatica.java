...
public class DatosInformatica {
  ...
  public static List<Cuatrimestre> inicializarData() throws NoTimeException
  {
    ...
    Materia algebra=new Materia("Álgebra",9,c1);
      algebra.agregarClase(new Clase(DiaDeLaSemana.MARTES,Sede.MADERO,9,13));
      algebra.agregarClase(new Clase(DiaDeLaSemana.JUEVES,Sede.MADERO,9,14));
    Materia analisis1=new Materia("Análisis Matemático I",6,c1);
      analisis1.agregarClase(new Clase(DiaDeLaSemana.MIERCOLES,Sede.MADERO,8,11));
      analisis1.agregarClase(new Clase(DiaDeLaSemana.VIERNES,Sede.MADERO,8,11));
    Materia introInfo=new Materia("Introducción a la Informática",3,c1);
      introInfo.agregarClase(new Clase(DiaDeLaSemana.LUNES,Sede.MADERO,8,11));
    Materia metodologia=new Materia("Metodología del Aprendizaje",3,c1);
      metodologia.agregarClase(new Clase(DiaDeLaSemana.LUNES,Sede.MADERO,14,17));
    Materia sistemasDeRep=new Materia("Sistemas de Representación",3,c1);
      sistemasDeRep.agregarClase(new Clase(DiaDeLaSemana.MIERCOLES,Sede.MADERO,14,17));
    Materia analisis2=new Materia("Análisis Matemático II",6,c2);
      analisis2.agregarClase(new Clase(DiaDeLaSemana.LUNES,Sede.MADERO,12,14));
      analisis2.agregarClase(new Clase(DiaDeLaSemana.MARTES,Sede.MADERO,11,13));
      analisis2.agregarClase(new Clase(DiaDeLaSemana.JUEVES,Sede.MADERO,13,15));
    Materia fisica1=new Materia("Física I",6,c2);
      fisica1.agregarClase(new Clase(DiaDeLaSemana.MARTES,Sede.MADERO,8,10));
      fisica1.agregarClase(new Clase(DiaDeLaSemana.JUEVES,Sede.MADERO,11,13));
      fisica1.agregarClase(new Clase(DiaDeLaSemana.VIERNES,Sede.MADERO,8,10));
    Materia mateDiscreta=new Materia("Matemática Discreta",6,c2);
      mateDiscreta.agregarClase(new Clase(DiaDeLaSemana.LUNES,Sede.MADERO,8,11));
      mateDiscreta.agregarClase(new Clase(DiaDeLaSemana.JUEVES,Sede.MADERO,8,11));
    Materia pi=new Materia("Programación Imperativa",9,c2);
      pi.agregarClase(new Clase(DiaDeLaSemana.MARTES,Sede.MADERO,13,17));
      pi.agregarClase(new Clase(DiaDeLaSemana.MIERCOLES,Sede.MADERO,10,13));
      pi.agregarClase(new Clase(DiaDeLaSemana.VIERNES,Sede.MADERO,10,12));
    Materia xml=new Materia("Diseño y Porcesamiento de Documentos XML",3,c3);
        xml.agregarClase(new Clase(DiaDeLaSemana.MIERCOLES, Sede.MADERO,9,12));
    Materia fisica2=new Materia("Física II",6,c3);
        fisica2.agregarClase(new Clase(DiaDeLaSemana.LUNES,Sede.MADERO,13,15));
        fisica2.agregarClase(new Clase(DiaDeLaSemana.MARTES,Sede.MADERO,17,19));
        fisica2.agregarClase(new Clase(DiaDeLaSemana.MIERCOLES,Sede.MADERO,13,15));
    Materia poo=new Materia("Programación Orientada a Objetos",6,c3);
        poo.agregarClase(new Clase(DiaDeLaSemana.LUNES,Sede.MADERO,16,18));
        poo.agregarClase(new Clase(DiaDeLaSemana.VIERNES,Sede.MADERO,16,20));
    Materia logica=new Materia("Lógica Computacional",6,c3);
        logica.agregarClase(new Clase(DiaDeLaSemana.LUNES,Sede.MADERO,11,13));
        logica.agregarClase(new Clase(DiaDeLaSemana.MARTES,Sede.MADERO,9,11));
        logica.agregarClase(new Clase(DiaDeLaSemana.MARTES,Sede.MADERO,14,16));
    Materia quimica=new Materia("Química",3,c3);
        quimica.agregarClase(new Clase(DiaDeLaSemana.VIERNES,Sede.MADERO,8,11));
    Materia arqui=new Materia("Arquitectura de Computadoras",6,c4);
        arqui.agregarClase(new Clase(DiaDeLaSemana.LUNES,Sede.MADERO,16,19));
        arqui.agregarClase(new Clase(DiaDeLaSemana.MIERCOLES,Sede.MADERO,16,19));
    Materia eda=new Materia("Estructura de Datos y Algoritmos",6,c4);
        eda.agregarClase(new Clase(DiaDeLaSemana.LUNES,Sede.MADERO,14,16));
        eda.agregarClase(new Clase(DiaDeLaSemana.MARTES,Sede.MADERO,17,21));
    Materia fisica3=new Materia("Física III",6,c4);
        fisica3.agregarClase(new Clase(DiaDeLaSemana.JUEVES,Sede.MADERO,14,18));
        fisica3.agregarClase(new Clase(DiaDeLaSemana.VIERNES,Sede.MADERO,14,16));
    Materia proba=new Materia("Probabilidad y Estadística",6,c4);
        proba.agregarClase(new Clase(DiaDeLaSemana.LUNES,Sede.MADERO,11,13));
        proba.agregarClase(new Clase(DiaDeLaSemana.MARTES,Sede.MADERO,11,13));
        proba.agregarClase(new Clase(DiaDeLaSemana.JUEVES,Sede.MADERO,11,13));
    Materia baseDeDatos1=new Materia("Base de Datos I",6,c5);
        baseDeDatos1.agregarClase(new Clase(DiaDeLaSemana.MARTES,Sede.MADERO,14,17));
        baseDeDatos1.agregarClase(new Clase(DiaDeLaSemana.JUEVES,Sede.MADERO,10,13));
    Materia ingeSoft1=new Materia("Ingeniería de Software I",6,c5);
        ingeSoft1.agregarClase(new Clase(DiaDeLaSemana.MARTES,Sede.MADERO,11,14));
        ingeSoft1.agregarClase(new Clase(DiaDeLaSemana.JUEVES,Sede.MADERO,14,17));
    Materia hci=new Materia("Interaccion Hombre-computadora",6,c5);
        hci.agregarClase(new Clase(DiaDeLaSemana.LUNES,Sede.MADERO,19,22));
        hci.agregarClase(new Clase(DiaDeLaSemana.JUEVES,Sede.MADERO,18,21));
    Materia sistemasOperativos=new Materia("Sistemas Operativos",6,c5);
        sistemasOperativos.agregarClase(new Clase(DiaDeLaSemana.MARTES,Sede.MADERO,19,22));
        sistemasOperativos.agregarClase(new Clase(DiaDeLaSemana.MIERCOLES,Sede.MADERO,18,21));
    Materia automatas=new Materia("Autómatas, Teoría de Lenguajes y Compiladores",6,c6);
        automatas.agregarClase(new Clase(DiaDeLaSemana.JUEVES,Sede.SDT,15,18));
        automatas.agregarClase(new Clase(DiaDeLaSemana.VIERNES,Sede.SDT,15,18));
    Materia formacionGral1=new Materia("Formación General I",3,c6);
        formacionGral1.agregarClase(new Clase(DiaDeLaSemana.LUNES,Sede.MADERO,14,17));
    Materia metodosNumericos=new Materia("Métodos Numéricos",3,c6);
        metodosNumericos.agregarClase(new Clase(DiaDeLaSemana.LUNES,Sede.MADERO,8,11));
    Materia protos=new Materia("Protocolos de Comunicación",6,c6);
        protos.agregarClase(new Clase(DiaDeLaSemana.MARTES,Sede.SDT,15,18));
        protos.agregarClase(new Clase(DiaDeLaSemana.MIERCOLES,Sede.MADERO,15,18));
    Materia paw=new Materia("Proyecto de Aplicaciones Web",6,c6);
        paw.agregarClase(new Clase(DiaDeLaSemana.LUNES,Sede.MADERO,19,22));
        paw.agregarClase(new Clase(DiaDeLaSemana.MIERCOLES,Sede.MADERO,19,22));
    Materia economia = new Materia ("Economía para Ingenieros", 3, c7, 147);
        economia.agregarClase(new Clase(DiaDeLaSemana.JUEVES, Sede.MADERO, 11, 14));
    Materia derecho = new Materia ("Derecho para Ingenieros", 3, c8, 144);
        derecho.agregarClase(new Clase(DiaDeLaSemana.MARTES, Sede.MADERO, 12, 15));
    Materia ingeSoft2 = new Materia ("Ingeniería de Software II", 3, c7, 147);
        ingeSoft2.agregarClase(new Clase(DiaDeLaSemana.JUEVES, Sede.MADERO, 19, 21));
    Materia baseDeDatos2 = new Materia ("Base De Datos II", 6, c7, 147);
        baseDeDatos2.agregarClase(new Clase(DiaDeLaSemana.LUNES, Sede.SDT, 14, 17));
        baseDeDatos2.agregarClase(new Clase(DiaDeLaSemana.MARTES, Sede.SDT, 19, 22));
    Materia progObjDist = new Materia ("Programación de Objetos Distribuidos", 3, c8, Periodo.SEGUNDO, 147);
        progObjDist.agregarClase(new Clase(DiaDeLaSemana.MIERCOLES, Sede.SDT, 18, 21));
    Materia metodosNumAvanzados = new Materia ("Métodos Numéricos Avanzados", 6, c8, Periodo.SEGUNDO, 147);
        metodosNumAvanzados.agregarClase(new Clase(DiaDeLaSemana.JUEVES, Sede.MADERO, 14, 17));
        metodosNumAvanzados.agregarClase(new Clase(DiaDeLaSemana.VIERNES, Sede.MADERO, 12, 15));
    Materia simulacion = new Materia ("Simulación de Sistemas", 6, c8, 147);
        simulacion.agregarClase(new Clase(DiaDeLaSemana.LUNES, Sede.SDT, 10, 13));
        simulacion.agregarClase(new Clase(DiaDeLaSemana.MIERCOLES, Sede.SDT, 10, 13));
    Materia sistInteligencia = new Materia ("Sistemas de Inteligencia Artificial", 6, c7, Periodo.PRIMERO, 147);
        sistInteligencia.agregarClase(new Clase(DiaDeLaSemana.LUNES, Sede.SDT, 12, 15));
        sistInteligencia.agregarClase(new Clase(DiaDeLaSemana.MIERCOLES, Sede.SDT, 15, 18));
    Materia gestion = new Materia ("Gestión de Proyectos Informáticos", 3, c8, 147);
        gestion.agregarClase(new Clase(DiaDeLaSemana.MIERCOLES,Sede.SDT, 15, 18));
    Materia cripto = new Materia ("Criptografía y Seguridad", 6, c7, Periodo.PRIMERO, 147);
        cripto.agregarClase(new Clase(DiaDeLaSemana.LUNES, Sede.SDT, 15, 18));
        cripto.agregarClase(new Clase(DiaDeLaSemana.JUEVES, Sede.MADERO, 16, 19));
    Materia redes = new Materia ("Redes de Información", 6, c9, Periodo.PRIMERO, 147);
        redes.agregarClase(new Clase(DiaDeLaSemana.LUNES, Sede.SDT, 19, 22));
        redes.agregarClase(new Clase(DiaDeLaSemana.MIERCOLES, Sede.SDT, 19, 22));
    ...
    Materia seguridad = new Materia ("Seguridad Ocupacional", 3, c10,140);
        seguridad.agregarClase(new Clase(DiaDeLaSemana.JUEVES, Sede.MADERO, 18, 21));
